...
<p align="center">
  <img alt="GitCron version" src="https://img.shields.io/badge/GitCron-v1.16.0-fd9d1a?style=for-the-badge&amp;labelColor=2c3440">
...
| Platform | File                                                                  |
| -------- | --------------------------------------------------------------------- |
| Windows  | `GitCron Setup 1.16.0.exe`                                            |
| macOS    | `GitCron-1.16.0.dmg` _(build on macOS with `pnpm package:mac`)_       |
| Linux    | `GitCron-1.16.0.AppImage` _(build on Linux with `pnpm package:linux`)_ |
