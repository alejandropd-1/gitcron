...
<p align="center">
  <img alt="GitCron version" src="https://img.shields.io/badge/GitCron-v1.3.5-fd9d1a?style=for-the-badge&amp;labelColor=2c3440">
...
| Platform | File                                                                  |
| -------- | --------------------------------------------------------------------- |
| Windows  | `GitCron Setup 1.3.5.exe`                                             |
| macOS    | `GitCron-1.3.5.dmg` _(build on macOS with `pnpm package:mac`)_        |
| Linux    | `GitCron-1.3.5.AppImage` _(build on Linux with `pnpm package:linux`)_ |
...
`v1.3.5` - see [CHANGELOG.md](/C:/www/gitCronos/CHANGELOG.md) for recent changes.
