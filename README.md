...
<p align="center">
  <img alt="GitCron version" src="https://img.shields.io/badge/GitCron-v1.6.0-fd9d1a?style=for-the-badge&amp;labelColor=2c3440">
...
| Platform | File                                                                  |
| -------- | --------------------------------------------------------------------- |
| Windows  | `GitCron Setup 1.6.0.exe`                                             |
| macOS    | `GitCron-1.6.0.dmg` _(build on macOS with `pnpm package:mac`)_        |
| Linux    | `GitCron-1.6.0.AppImage` _(build on Linux with `pnpm package:linux`)_ |
...
- **Core & Vista Clásica (Estable)**: `v1.6.0` - ver [CHANGELOG.md](/CHANGELOG.md) para más detalles.
