...
import { HistoryView, CommitTabView, PullRequestDiffView, FileDiffView } from '@/components/RepoContentViews';
...
import { DeferredPanelLoading, GraphColumnHandle, LcarsDecorPanel } from '@/components/PageWidgets';
  ...
  return (
    <div className="flex flex-col h-screen bg-bg-base text-text-primary font-sans overflow-hidden select-none">
        ...
        >
          {activeView === 'settings' ? (
            ...
            <PullRequestDiffView
              ...
              pullRequestDiffLoading={pullRequestDiffLoading}
              wordWrap={wordWrap}
            ...
            <FileDiffView
              ...
              conflictFileContent={conflictFileContent}
              isSaving={isLoading}
              onSaveConflict={async (content) => {
      ...
      <StashPreviewModal
        ...
        onClose={() => setStashPreviewState(null)}
      />
      ...
      {/* ──────────── RESET COMMIT MODAL ──────────── */}
      <ResetCommitModal
        commitHash={resetCommitFrom}
        onClose={() => setResetCommitFrom(undefined)}
        onConfirm={handleResetCommit}
      />
      {/* ──────────── BRANCH CONTEXT MENU ──────────── */}
      <AnimatePresence>
        {branchMenu && (
      ...
      <AnimatePresence>
        {contextMenu && (
          <CommitContextMenu
            ...
            onReset={() => { setResetCommitFrom(contextMenu.hash); setContextMenu(null); }}
