...
function ConflictCodeBlock({ title, label, lines, tone }: { title: string; label: string; lines: string[]; tone: 'ours' | 'theirs' | 'base' }) {
  ...
  return (
    <div className="min-w-0">
      ...
      <pre className="max-h-40 overflow-auto rounded-b border-x border-b border-border-subtle/15 bg-bg-surface p-2 text-[11px] leading-relaxed text-text-primary font-mono whitespace-pre">
    ...
    <div className="border-b border-border-subtle/15 bg-bg-base/45 shrink-0 overflow-hidden">
              ...
              <div className="py-2 flex items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap justify-end gap-1.5">
                  <button
                    ...
                    className="px-2 py-1 text-[10px] rounded border border-secondary/35 text-secondary hover:bg-secondary hover:text-bg-base transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-[10px] rounded border border-primary/35 text-primary hover:bg-primary hover:text-bg-base transition-colors"
                  >
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-3">
                ...
                <label className="xl:col-span-2 min-w-0">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-28 max-h-64 bg-bg-surface border border-border-subtle/20 rounded p-2 text-[11px] leading-relaxed text-text-primary font-mono resize-y focus:outline-none focus:border-git-mod/50"
                    spellCheck={false}
                  />
                </label>
              </div>
      ...
      <div className="px-4 py-3 border-t border-border-subtle/15 bg-bg-surface/35 flex items-center justify-between gap-3">
        ...
        <button
          ...
          disabled={isSaving}
          className="shrink-0 px-4 py-2 bg-gradient-to-br from-git-add to-git-add/80 hover:from-git-add hover:to-git-add/90 shadow-lg shadow-secondary/20 disabled:opacity-40 disabled:cursor-not-allowed text-bg-base text-sm font-bold rounded flex items-center gap-2"
        >
