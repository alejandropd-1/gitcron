  ...
  return (
    ...
    <div className={cn('glass-alert-warning rounded-lg p-3 text-sm', className)}>
      ...
      {showRaw && (
        ...
        <pre className="mt-1 max-h-48 select-text overflow-auto whitespace-pre-wrap break-words rounded bg-black/40 p-2 text-[length:var(--font-size-xs)] text-warning/80">
          {failure.raw}
        </pre>
      )}
    </div>
