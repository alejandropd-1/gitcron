      ...
      {checkoutConflict && (
        ...
        >
          ...
          >
            ...
            <div className="bg-bg-base border border-border-subtle/15 rounded p-3 mb-4 text-[length:var(--font-size-xs)] font-mono text-text-secondary/70 max-h-32 overflow-y-auto">
            ...
            <p className="text-[length:var(--font-size-xs)] text-text-secondary/70 mt-3 text-center">
        ...
        >
          ...
          >
            ...
            <div className="flex items-start gap-2 p-3 rounded bg-warning/10 border border-warning/30 text-warning mb-4">
              ...
              <p className="text-[length:var(--font-size-xs)] leading-relaxed font-semibold">{t('cleanModal.warning')}</p>
            </div>

            <div className="flex items-center justify-between gap-3 mb-2">
              <span className="text-[length:var(--font-size-2xs)] text-text-secondary font-bold uppercase tracking-wider">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="text-[length:var(--font-size-2xs)] text-secondary hover:text-bg-base px-2 py-0.5 rounded border border-secondary/40 hover:bg-secondary transition-colors disabled:opacity-40"
                >
                ...
                <button
                  ...
                  disabled={cleanModalLoading || cleanableFiles.length === 0}
                  className="text-[length:var(--font-size-2xs)] text-text-secondary hover:text-bg-base px-2 py-0.5 rounded border border-border-subtle hover:bg-border-subtle transition-colors disabled:opacity-40"
                >
        ...
        >
          ...
          >
            ...
            <div className="space-y-3 flex-1 overflow-y-auto scrollbar-thin">
              <div>
                <label className="text-[length:var(--font-size-2xs)] uppercase tracking-wider font-bold text-text-secondary block mb-1">
        ...
        >
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <label className="text-[length:var(--font-size-2xs)] uppercase tracking-wider font-bold text-text-secondary block mb-2">
      ...
      <div className="flex items-start gap-4 mb-5">
        ...
        <div className="flex-1">
          ...
          <div className="bg-bg-base/80 border border-border-subtle/25 rounded-xl p-3 mb-1">
            <p className="text-[length:var(--font-size-2xs)] text-error uppercase tracking-wider font-bold mb-1 flex items-center gap-1.5">
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="mt-5 rounded border border-border-subtle/20 bg-bg-base/75 p-3">
          <p className="mb-1 text-[length:var(--font-size-2xs)] font-bold uppercase text-text-secondary">
        ...
        {remoteOpen && (
          <form onSubmit={handleRemoteSubmit} className="mt-4 rounded border border-border-subtle/20 bg-bg-base/55 p-3">
            <label className="mb-1.5 block text-[length:var(--font-size-2xs)] font-extrabold uppercase tracking-wider text-text-secondary">
              ...
              <div className="mt-3 rounded border border-warning/30 bg-warning/10 p-3">
                <div className="flex items-start gap-2 text-xs leading-relaxed text-text-primary">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-[length:var(--font-size-xs)] text-text-secondary">
                      {pendingRepo?.isInitialized
    ...
    <ModalShell open={show} onClose={resetAndClose} panelClassName="glass-overlay rounded-xl shadow-2xl p-6 w-[min(calc(100vw-2rem),600px)]">
      ...
      {mode === 'choose' ? (
        ...
        <form onSubmit={handleLink}>
          <label htmlFor="publish-remote-url" className="mb-1.5 block text-[length:var(--font-size-2xs)] font-extrabold uppercase tracking-wider text-text-secondary">
