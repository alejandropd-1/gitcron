          ...
          >
            ...
            <div className="grid grid-cols-[220px_minmax(0,1fr)] gap-3 min-h-0 flex-1">
              <div className="rounded border border-border-subtle/15 bg-bg-base/70 overflow-hidden min-h-0">
                <div className="px-3 py-2 border-b border-border-subtle/15 text-[length:var(--font-size-2xs)] font-bold uppercase tracking-wider text-text-secondary">
              ...
              <pre
                tabIndex={0}
                className="rounded border border-border-subtle/15 bg-bg-surface p-3 overflow-auto max-h-[52vh] text-[length:var(--font-size-xs)] leading-relaxed text-text-primary font-mono whitespace-pre"
              >
