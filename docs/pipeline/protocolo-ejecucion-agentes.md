...
- identidad declarada: IA, runtime, modelo y rol (`scout`, `planner`, `builder`, `auditor`,
  `fixer` u `orchestrator` para el MASTER designado, sea Codex, Hermes u otro runtime);
