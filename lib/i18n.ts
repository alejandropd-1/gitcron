...
const es: Dict = {
  ...
  'cartography.lenses': 'Lentes',
  'cartography.lens.panorama': 'Panorama',
  'cartography.lens.explorer': 'Explorador',
  'cartography.lens.graph': 'Grafo',
  'cartography.mode.simple': 'Simple',
  'cartography.mode.technical': 'Técnico',
  'cartography.refresh': 'Refrescar',
  'cartography.scanning': 'Escaneando el árbol…',
  'cartography.scanError': 'No se pudo escanear el repositorio',
  'cartography.treeEmpty': 'No hay archivos para mostrar',
  'cartography.treeStats': '{{dirs}} carpetas · {{files}} archivos',
  'cartography.truncated': 'árbol parcial (demasiados archivos)',
  'cartography.panorama.loading': 'Armando el panorama…',
  'cartography.panorama.summary': 'Qué es',
  'cartography.panorama.generating': 'Generando orientación…',
  'cartography.panorama.aiEmpty': 'No hay orientación generada todavía.',
  'cartography.panorama.aiOff': 'IA desactivada. El mapa determinista de grupos y flechas ya está listo; activá Cartografía AI para generar el resumen y los recorridos.',
  'cartography.panorama.aiError': 'No se pudo generar el panorama',
  'cartography.panorama.refreshAi': 'Refrescar IA',
  'cartography.panorama.structure': 'estructura {{hash}}',
  'cartography.panorama.groupLinks': 'Flechas entre grupos',
  'cartography.panorama.keyFiles': 'Archivos clave',
  'cartography.panorama.guidedFlows': 'Recorrido guiado',
  ...
  // Fase 3 — grounding estructural (CodeGraph)
  'cartography.graph.relations': 'Relaciones (CodeGraph)',
  'cartography.graph.selectFile': 'Seleccioná un archivo para ver sus relaciones reales.',
  'cartography.graph.indexing': 'Indexando el grafo…',
  'cartography.graph.notReady': 'El grafo todavía se está indexando.',
  'cartography.graph.notCode': 'Este archivo no es código — está fuera del grafo.',
  'cartography.graph.error': 'No se pudo leer el grafo',
  'cartography.graph.imports': 'Importa a',
  'cartography.graph.usedBy': 'Es usado por',
  ...
  'cartography.semantic.stats': '{{nodes}}/{{totalNodes}} archivos · {{edges}}/{{totalEdges}} relaciones',
  'cartography.semantic.limited': 'vista acotada',
  'cartography.semantic.view.columns': 'Columnas',
  'cartography.semantic.view.nodes': 'Nodos',
  'cartography.semantic.selectNodeForLinks': 'Elegí un archivo para ver sólo sus dependencias.',
  'cartography.semantic.nodesOverview': 'Resumen: elegí un nodo para abrir su barrio de dependencias.',
  'cartography.semantic.hiddenNeighbors': '+{{count}} vecinos ocultos para mantenerlo legible',
  'cartography.semantic.filesCount': '{{count}} archivos',
  'cartography.semantic.usesCount': 'usa {{count}}',
  'cartography.semantic.usedByCount': 'lo usan {{count}}',
  'cartography.semantic.focus': 'foco',
  'cartography.semantic.usesFocus': 'usa el foco',
  'cartography.semantic.focusUses': 'lo usa el foco',
  ...
  'cartography.detail.symbols': 'Símbolos',
  'cartography.detail.explainHint': 'Explicar “{{name}}” con IA',
  ...
  'cartography.ai.modelPlaceholderOnline': 'p. ej. anthropic/claude-sonnet-4.5',
...
const en: Dict = {
  ...
  'cartography.lenses': 'Lenses',
  'cartography.lens.panorama': 'Panorama',
  'cartography.lens.explorer': 'Explorer',
  'cartography.lens.graph': 'Graph',
  'cartography.mode.simple': 'Simple',
  'cartography.mode.technical': 'Technical',
  'cartography.refresh': 'Refresh',
  'cartography.scanning': 'Scanning the tree…',
  'cartography.scanError': 'Could not scan the repository',
  'cartography.treeEmpty': 'No files to show',
  'cartography.treeStats': '{{dirs}} folders · {{files}} files',
  'cartography.truncated': 'partial tree (too many files)',
  'cartography.panorama.loading': 'Building the panorama…',
  'cartography.panorama.summary': 'What it is',
  'cartography.panorama.generating': 'Generating orientation…',
  'cartography.panorama.aiEmpty': 'No orientation has been generated yet.',
  'cartography.panorama.aiOff': 'AI is off. The deterministic group map and arrows are ready; enable Cartography AI to generate the summary and guided flows.',
  'cartography.panorama.aiError': 'Could not generate the panorama',
  'cartography.panorama.refreshAi': 'Refresh AI',
  'cartography.panorama.structure': 'structure {{hash}}',
  'cartography.panorama.groupLinks': 'Group arrows',
  'cartography.panorama.keyFiles': 'Key files',
  'cartography.panorama.guidedFlows': 'Guided tour',
  ...
  // Phase 3 — structural grounding (CodeGraph)
  'cartography.graph.relations': 'Relations (CodeGraph)',
  'cartography.graph.selectFile': 'Select a file to see its real relations.',
  'cartography.graph.indexing': 'Indexing the graph…',
  'cartography.graph.notReady': 'The graph is still indexing.',
  'cartography.graph.notCode': "This file isn't code — it's outside the graph.",
  'cartography.graph.error': 'Could not read the graph',
  'cartography.graph.imports': 'Imports',
  'cartography.graph.usedBy': 'Used by',
  ...
  'cartography.semantic.stats': '{{nodes}}/{{totalNodes}} files · {{edges}}/{{totalEdges}} relations',
  'cartography.semantic.limited': 'limited view',
  'cartography.semantic.view.columns': 'Columns',
  'cartography.semantic.view.nodes': 'Nodes',
  'cartography.semantic.selectNodeForLinks': 'Pick a file to show only its dependencies.',
  'cartography.semantic.nodesOverview': 'Overview: pick a node to open its dependency neighborhood.',
  'cartography.semantic.hiddenNeighbors': '+{{count}} hidden neighbors to keep this readable',
  'cartography.semantic.filesCount': '{{count}} files',
  'cartography.semantic.usesCount': 'uses {{count}}',
  'cartography.semantic.usedByCount': 'used by {{count}}',
  'cartography.semantic.focus': 'focus',
  'cartography.semantic.usesFocus': 'uses focus',
  'cartography.semantic.focusUses': 'focus uses',
  ...
  'cartography.detail.symbols': 'Symbols',
  'cartography.detail.explainHint': 'Explain “{{name}}” with AI',
  ...
  'cartography.ai.modelPlaceholderOnline': 'e.g. anthropic/claude-sonnet-4.5',
...
const zh: Dict = {
  ...
  'cartography.lenses': '透镜',
  'cartography.lens.panorama': '全景',
  'cartography.lens.explorer': '资源管理器',
  'cartography.lens.graph': '图谱',
  'cartography.mode.simple': '简单',
  'cartography.mode.technical': '技术',
  'cartography.refresh': '刷新',
  'cartography.scanning': '正在扫描文件树…',
  'cartography.scanError': '无法扫描仓库',
  'cartography.treeEmpty': '没有可显示的文件',
  'cartography.treeStats': '{{dirs}} 个文件夹 · {{files}} 个文件',
  'cartography.truncated': '部分文件树（文件过多）',
  'cartography.panorama.loading': '正在构建全景…',
  'cartography.panorama.summary': '它是什么',
  'cartography.panorama.generating': '正在生成导览…',
  'cartography.panorama.aiEmpty': '尚未生成导览。',
  'cartography.panorama.aiOff': 'AI 已关闭。确定性的分组地图和箭头已就绪；开启制图 AI 可生成摘要和引导流程。',
  'cartography.panorama.aiError': '无法生成全景',
  'cartography.panorama.refreshAi': '刷新 AI',
  'cartography.panorama.structure': '结构 {{hash}}',
  'cartography.panorama.groupLinks': '分组箭头',
  'cartography.panorama.keyFiles': '关键文件',
  'cartography.panorama.guidedFlows': '引导流程',
  ...
  // 第 3 阶段 — 结构基础（CodeGraph）
  'cartography.graph.relations': '关系 (CodeGraph)',
  'cartography.graph.selectFile': '选择一个文件以查看其真实关系。',
  'cartography.graph.indexing': '正在索引图谱…',
  'cartography.graph.notReady': '图谱仍在索引中。',
  'cartography.graph.notCode': '该文件不是代码 — 不在图谱中。',
  'cartography.graph.error': '无法读取图谱',
  'cartography.graph.imports': '导入',
  'cartography.graph.usedBy': '被引用于',
  ...
  'cartography.semantic.stats': '{{nodes}}/{{totalNodes}} 个文件 · {{edges}}/{{totalEdges}} 个关系',
  'cartography.semantic.limited': '受限视图',
  'cartography.semantic.view.columns': '列',
  'cartography.semantic.view.nodes': '节点',
  'cartography.semantic.selectNodeForLinks': '选择一个文件，只显示它的依赖关系。',
  'cartography.semantic.nodesOverview': '概览：选择一个节点以打开其依赖邻域。',
  'cartography.semantic.hiddenNeighbors': '+{{count}} 个邻近节点已隐藏以保持清晰',
  'cartography.semantic.filesCount': '{{count}} 个文件',
  'cartography.semantic.usesCount': '使用 {{count}}',
  'cartography.semantic.usedByCount': '被 {{count}} 使用',
  'cartography.semantic.focus': '焦点',
  'cartography.semantic.usesFocus': '使用焦点',
  'cartography.semantic.focusUses': '焦点使用',
  ...
  'cartography.detail.symbols': '符号',
  'cartography.detail.explainHint': '用 AI 解释“{{name}}”',
  ...
  'cartography.ai.modelPlaceholderOnline': '例如 anthropic/claude-sonnet-4.5',
