...
- [ ] 3.1 Declarar el estado sin OpenSpec en la pantalla de arranque
- [ ] 3.2 Mostrar las herramientas del repositorio y cuáles están sin configurar
- [ ] 3.3 Declarar lo que falta antes de empezar un cambio, ofreciendo resolverlo y sin impedir seguir
- [ ] 3.4 Conservar el objetivo y el slug al inicializar desde ese aviso
- [ ] 3.5 Espaciar lo agregado con la escala `--sp-1..--sp-6` de `.dashboard`

## 4. Inicialización

- [ ] 4.1 Ejecutar `openspec init` sin `--tools`, para que el CLI detecte
- [ ] 4.2 Enumerar los archivos que se van a escribir antes de escribirlos
- [ ] 4.3 Exigir acción humana explícita, sin preselección que la dispare por descuido
- [ ] 4.4 Pedir que se elija herramienta sólo cuando el comando falle por no detectar ninguna
- [ ] 4.5 Informar el motivo real de un fallo, sin normalizarlo, y releer la evidencia
...
- [ ] 5.7 Prueba: fallo de inicialización informa el motivo real
...
- [ ] 6.5 Reporte en `docs/reports/`, con las sondas como evidencia
